...
* 전략적 프로젝트 및 프로그램의 계획 수립부터 실행, 완료까지 End-to-End 딜리버리 리드

* 체계적인 일정 및 실행 관리를 통해 적시·고품질의 서비스 및 제품 딜리버리 실현

* Engineering, Product, Operations 등 다양한 Cross-functional 조직과 긴밀히 협업하여 공동 목표 달성

**Program \& Project Management Framework**

* 프로젝트 및 프로그램 관리 프레임워크, 표준, 베스트 프랙티스 정의 및 도입

* 지속적인 프로세스 개선을 통해 PMO 운영 효율성 극대화

**Incident \& Stakeholder Communications**

* 장애 및 인시던트 발생 시 심각도(Severity) 기반의 Escalation 프로세스 운영

* 명확하고 신속한 내·외부 이해관계자 커뮤니케이션 조율 및 리포팅 수행

**Process \& Operations Management**

* Jira, Confluence 등 협업, 문서화 및 시각화 도구를 활용한 운영 프로세스 관리

* 데이터 및 지표 기반의 지속적인 업무 프로세스 효율화 및 개선 추진

### 자격 요건

* Business, Computer Science, Engineering 또는 관련 분야의 학사 학위 이상을 보유 또는 이에 준하는 실무 경험을 보유하신 분  
* 기술 기반 조직에서 Program Management, Project Management, PMO 또는 Tech/Operations 분야 경력 3년 이상을 보유하신 분  
* 탄탄한 프로젝트/프로그램 관리 역량을 바탕으로 Cross-functional 프로젝트를 성공적으로 주도한 경험을 보유 하신 분  
* 우수한 기술/AI에 대한 감각(Technical/AI Sense)과 함께 Cross-functional 프로젝트를 주도한 경험을 보유하신 분  
* Jira, Confluence 등 프로젝트 관리 및 협업 도구 활용 경험을 보유하신 분  
* 우수한 커뮤니케이션 역량, 조직 운영 역량 및 이해관계자 관리 역량을 보유하신 분  
* 비즈니스 수준의 영어 커뮤니케이션 역량을 보유하신 분

**우대 사항**  
* 이커머스, 테크 기업 또는 빠르게 성장하는(Hyper-growth) 환경에서의 업무 경험을 보유하신 분  
* ChatGPT, Claude, Windsurf 등 AI 및 자동화 도구를 활용하여 리포팅, 문서화 및 업무 프로세스 효율화를 수행한 경험 또는 이에 대한 높은 관심이 있으신 분  
...
* **Program/Project Delivery Support:** Lead project/program end-to-end delivery and enable timely, high-quality delivery through structured planning and execution.  
* **Project/Program Management Framework:** Define, implement, and continuously improve project/program frameworks, standards, and best practices.  
...
* **Process \& Operations Management:** Utilize collaboration, documentation, and visualization tools to drive continuous operational improvement.

**Basic Qualifications**  
• Bachelor's degree in Business, Computer Science, Engineering, or a related field, or equivalent practical experience.  
• 3+ years of experience in Program/Project Management, PMO, or Tech/Operations roles within technology-driven organizations.  
• Solid core project management skills OR a good technical/AI sense with experience driving cross-functional projects.  
...
* Experience in e-commerce, tech, hyper-growth environments  
* Hands-on experience or strong interest in leveraging AI/automation tools (e.g., ChatGPT, Calude,Windsurf,etc.) to streamline reporting, documentation, and operational workflows.  
* Certifications such as PMP, PgMP, or Agile-related certifications (PMI-ACP, CSM, SAFe).
