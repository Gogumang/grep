/** 사이트가 쓰는 분류 셋. 블로그마다 제각각인 분류는 읽을 때 이 중 하나로 맞춘다. */
export type PostCategory = 'Engineering' | 'Design' | 'Product'
...
export interface Post {
  ...
  wideImage: string
  tags: string[]
  /** 원문 블로그가 매긴 분류를 셋 중 하나로 맞춘 값. 원문이 분류를 주지 않으면 Engineering이다. */
