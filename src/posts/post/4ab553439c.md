...
![](https://images.gogumang.com/4ab553439c/01.jpeg)
> This post is also available in [**Korean**](https://medium.com/coupang-engineering/기계-학습-모델을-활용한-물류-입고-프로세스-최적화-fe4490e44514).
...
![Potential resource waste in the supply process from vendors to Coupang fulfillment centers](https://images.gogumang.com/4ab553439c/02.png)
...
![Major tree-based algorithms’ predictive performance on the validation data set of the inbound requests to Coupang’s fulfillment centers](https://images.gogumang.com/4ab553439c/03.png)
...
![How the Coupang’s inbound reservation system and the ML model are integrated](https://images.gogumang.com/4ab553439c/04.png)
...
![Result of applying a ML model which predicts the number of trucks that a vendor needs to supply their products to Coupang fulfillment centers](https://images.gogumang.com/4ab553439c/05.png)
