...
![외부 채널 입고 정보 인터페이스 아키텍처(레거시)](https://images.gogumang.com/22149a0558/01.webp)
...
![실패 예상 지점](https://images.gogumang.com/22149a0558/02.webp)
...
![아웃박스 패턴이 적용된 카프카 프로듀스 아키텍처](https://images.gogumang.com/22149a0558/03.webp)
...
![namastack-outbox 라이브러리가 적용된 아웃박스 패턴](https://images.gogumang.com/22149a0558/04.webp)
...
![참 쉽죠](https://images.gogumang.com/22149a0558/05.webp)
...
![재시도 토픽 기반의 자가 치유 컨슘 흐름도](https://images.gogumang.com/22149a0558/06.webp)
...
![Spring Kafka 의 RetryableTopic 이 적용된 컨슘 흐름도](https://images.gogumang.com/22149a0558/07.webp)

크\~ 우리가 구현을 고민하던 대부분의 영역을 Spring Kafka 가 기능으로 제공해 주고 있습니다. 우리는 많은 것을 신경 쓸 필요 없이, 기존에 작성해 두었던 컨슈머 로직을 그대로 사용할 수 있어 보입니다.

![넌 영웅이야 스프링](https://images.gogumang.com/22149a0558/08.webp)
...
![슬랙 알람](https://images.gogumang.com/22149a0558/09.webp)

*컨슘 실패 알람이 이제는 오히려 반가워졌습니다! (녀석 기특하군!)*

이렇게 최종적으로 완성된, 아웃박스 패턴과 재시도 토픽이 적용된 입고 데이터 인터페이스 전체 아키텍처를 확인해 보겠습니다.

![아웃박스 패턴과 재시도 토픽이 결합된 최종 인터페이스 아키텍처](https://images.gogumang.com/22149a0558/10.webp)
