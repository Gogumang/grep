...
![실시간 스트림 조인 파이프라인 구성](https://hyperconnect.github.io/assets/2025-06-11-azar-flink-real-time-stream-join-service/Pipeline.png) 그림 1. 실시간 스트림 조인 파이프라인 구성
...
![Keyed Process Function을 이용한 이벤트 조합 로직](https://hyperconnect.github.io/assets/2025-06-11-azar-flink-real-time-stream-join-service/Keyed%20Process%20Function.png) 그림 2. KeyedProcessFunction을 이용한 이벤트 조합 로직
...
![도착/누락 시나리오별 KeyedProcessFunction의 조합 결과 예시](https://hyperconnect.github.io/assets/2025-06-11-azar-flink-real-time-stream-join-service/Keyed%20Process%20Function%20Example.png) 그림 3. 도착/누락 시나리오별 KeyedProcessFunction의 조합 결과 예시
...
![Savepoint 생성 후 복구 완료 시점까지의 만료된 타이머](https://hyperconnect.github.io/assets/2025-06-11-azar-flink-real-time-stream-join-service/Savepoint%20With%20Timer.png) 그림 4. Savepoint 생성 후 복구 완료 시점까지의 만료된 타이머
...
![Blue-Green 배포 과정](https://hyperconnect.github.io/assets/2025-06-11-azar-flink-real-time-stream-join-service/Blue-Green%20Deployment.png) 그림 5. Blue-Green 배포 과정
...
![중복 제거 Flink 애플리케이션 별도 구성](https://hyperconnect.github.io/assets/2025-06-11-azar-flink-real-time-stream-join-service/Exactly%20Once%20Semantics%20Legacy.png) 그림 6. 중복 제거(Deduplication, Dedup) Flink 애플리케이션 별도 구성
...
![Redis의 Atomic 연산을 활용한 중복 제거(Exactly Once) 파이프라인](https://hyperconnect.github.io/assets/2025-06-11-azar-flink-real-time-stream-join-service/Exactly%20Once%20Semantics.png) 그림 7. Redis의 Atomic 연산을 활용한 중복 제거(Exactly Once) 파이프라인
