...
![1.png](https://teamdable.github.io/techblog/assets/images/Bid_shading/1.png)
...
![2.png](https://teamdable.github.io/techblog/assets/images/Bid_shading/2.png)
...
![3.png](https://teamdable.github.io/techblog/assets/images/Bid_shading/3.png)

입찰 쉐이딩의 정량적 목표는 잉여를 최대화하는 것이며, 이때 잉여는 수학적으로 아래와 같이 정의됩니다:

\\\[S(b; V, \\hat{b}) = (V-b)I(b \> \\hat{b}) = \\begin{cases} V-b, \&\\;\\;\\text{if}\\;\\; b \> \\hat{b}, \\\\ 0, \&\\;\\;\\text{otherwise.}\\end{cases}\\\]
...
**1) 최소 승리 가격이 제공되는 경우** ![4.png](https://teamdable.github.io/techblog/assets/images/Bid_shading/4.png)
...
\\\[\\max_{\\alpha, \\;\\hat{b}\|x \\in \\mathcal{D}} \\sum_{i=1}\^{n} \\log f\\left( \\hat{b}_i; \\alpha(x\^{(i)}) \\right)\\\]

**2) 최소 승리 가격이 제공되지 않는 경우** ![5.png](https://teamdable.github.io/techblog/assets/images/Bid_shading/5.png)
...
\\\[\\max_{\\alpha, \\;\\hat{b}\|x \\in \\mathcal{D}} \\sum_{i=1}\^{n} L\\left( F\\left( \\hat{b}_i; \\alpha(x\^{(i)}) \\right), \\ell_i \\right)\\\]
...
\\\[s(b; V, x) = (V-b)\\Pr(\\hat{b} \< b; \\hat{b} \\;\|\\; x )\\\]
...
![6.png](https://teamdable.github.io/techblog/assets/images/Bid_shading/6.png)
...
![7.png](https://teamdable.github.io/techblog/assets/images/Bid_shading/7.png)
...
![8.png](https://teamdable.github.io/techblog/assets/images/Bid_shading/8.png)
...
![9.png](https://teamdable.github.io/techblog/assets/images/Bid_shading/9.png)
