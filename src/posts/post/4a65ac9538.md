...
![](/images/4a65ac9538/01.avif) filte=blob:none 없이는 클론 불가, 너무나 거대해진 모노레포!
...
![](/images/4a65ac9538/02.avif) 각 서비스가 독립적으로 빌드되도록 설정한 후, 6개의 빌드 파이프라인이 동적으로 생성되어 병렬로 실행되는 모습 ![](/images/4a65ac9538/03.avif) 각 파이프라인은 독립된 리소스가 할당된 가상 Machine에서 따로 실행됨
