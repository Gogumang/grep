...
![](/images/97b7be92da/05.png)

헬스 체크에서 서버에 문제가 발견되면 로드 밸런서는 해당 서버로 요청을 보내지 않게 됩니다.
![](/images/97b7be92da/06.png) ![](/images/97b7be92da/07.png)
