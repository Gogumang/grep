...
![](https://images.gogumang.com/4d2b48fa30/01.avif) <https://github.com/nodejs/node/pull/45011>
...
![](https://images.gogumang.com/4d2b48fa30/02.avif)
![](https://images.gogumang.com/4d2b48fa30/03.svg)
디버깅 코드
...
![](https://static.toss.im/ipd-tcs/toss_core/live/d3166491-8f5d-47cc-9be4-a72738be51ee/carbon_(3).png)

### Reserved Characters

Node.js에서 hostname을 왜 이렇게 파싱할까요? [RFC 3986](https://www.rfc-editor.org/rfc/rfc3986)는 Standard URI Syntax 를 정의해둔 문서인데요. **2.2 Reserved Characters**를 보면 그 이유를 찾을 수 있어요.
![](https://images.gogumang.com/4d2b48fa30/04.avif) <https://www.rfc-editor.org/rfc/rfc3986#section-2.2>
...
![](https://images.gogumang.com/4d2b48fa30/05.avif) 파라미터로 입력한 url과 node-fetch에서 실제로 요청한 URL 콘솔 출력
...
![](https://images.gogumang.com/4d2b48fa30/06.avif) 토스 버그바운티 챌린지

저 또한 버그바운티 프로그램을 통해 Node.js 측에 취약점을 제보하였고, 취약점을 알맞게 패치할 수 있는 방안들에 대해 논의하면서 컨트리뷰션을 시작했어요.
![](https://images.gogumang.com/4d2b48fa30/07.avif) Node.js url.parse() 취약점 제보
...
![](https://images.gogumang.com/4d2b48fa30/10.avif) <https://nodejs.org/api/url.html#urlparseurlstring-parsequerystring-slashesdenotehost>
