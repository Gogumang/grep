...
![](https://cdn-images-1.medium.com/max/1024/1*r-iwNRTZ7xDhcZJ0B1ERrg.jpeg)This post is also available in [**Korean**](https://medium.com/coupang-engineering/쿠팡의-머신러닝-플랫폼을-통한-ml-개발-가속화-de29804148bb).
...
> · [ML @ Coupang](#5959)
> · [Motivation](#534f)
> ∘ [1. Reduce time to production](#79be)
> ∘ [2. Incorporate CI/CD in ML development](#14dc)
> ∘ [3. Scale ML compute efficiently](#bd5e)
> · [Core offerings of Coupang ML Platform](#46a6)
> ∘ [1. Notebooks \& ML Pipeline Authoring](#5cf8)
> ∘ [2. Feature Engineering](#4adb)
> ∘ [3. Model Training](#a499)
> ∘ [4. Model Inference](#5b6c)
> ∘ [5. Monitoring \& Observability](#6536)
> ∘ [6. Training \& Inference Clusters](#cf93)
> · [Success Stories](#bcca)
> ∘ [1. Training Ko-BERT to understand search queries better](#671d)
> ∘ [2. Real-time price forecasting of products](#2284)
...
![An overview of Coupang ML Platform](https://cdn-images-1.medium.com/max/838/1*ki27OtAMLOA91Tqg_djvFw.png)**Figure 1.**Coupang ML Platform overview
...
![Coupang ML Platform’s training workflow](https://cdn-images-1.medium.com/max/720/1*Fc2rm6L1FqWmAxSzbO-UpQ.png)**Figure 2.** Training workflow![Coupang ML Platform’s serving workflow](https://cdn-images-1.medium.com/max/950/1*G8BK042RU2PBvCLm9x4Y1g.png)**Figure 3.** Serving workflow
...
![Coupang ML Platform’s monitoring serving](https://cdn-images-1.medium.com/max/548/1*JoMJ0x8dWJf_ORGd82Iheg.png)![Coupang ML Platform’s monitoring serving](https://cdn-images-1.medium.com/max/511/1*ps5ORx_eAKTUaFKOnrsdog.png)**Figure 4.** Monitoring serving
...
![Coupang ML Platform’s monitoring GPU utilization of its training cluster](https://cdn-images-1.medium.com/max/1024/1*_RtWkS0_mz_vv00dttkdGQ.png)**Figure 5.** Monitoring GPU utilization of Training cluster
...
![](https://medium.com/_/stat?event=post.clientViewed&referrerSource=full_rss&postId=cd00e9ccc172)

*** ** * ** ***

[Meet Coupang's Machine Learning Platform](https://medium.com/coupang-engineering/meet-coupangs-machine-learning-platform-cd00e9ccc172) was originally published in [Coupang Engineering Blog](https://medium.com/coupang-engineering) on Medium, where people are continuing the conversation by highlighting and responding to this story.