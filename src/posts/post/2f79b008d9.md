...
이 글은 Windows 기반의 서버 인프라를 개발하고 운영하는 DevOps 엔지니어들, 그리고 Windows 기반의 소프트웨어 개발에 익숙한 개발자들 중 컨테이너 기술에 관심을 가지는 개발자들을 위하여 작성하였습니다.

또한 이 글은 컨테이너의 기본 개념이나 Docker, Kubernetes의 사용법을 어느정도 숙지한 분들을 위한 글입니다. 만약 컨테이너, Docker 및 Kubernetes의 기본 개념을 처음 접하신다면 먼저 해당 개념들을 숙지하신 후에 이 글을 읽으실 것을 권장합니다.
...
![containerfund](https://images.gogumang.com/2f79b008d9/01.png) Windows 컨테이너 개요 - [출처](https://docs.microsoft.com/en-us/virtualization/windowscontainers/about/)
...
![hns management stack](https://images.gogumang.com/2f79b008d9/02.png) HCS와 HNS - [출처](https://docs.microsoft.com/en-us/virtualization/windowscontainers/container-networking/architecture)
...
![container arch linux](https://images.gogumang.com/2f79b008d9/03.png) 리눅스 컨테이너 아키텍처 - [출처](https://docs.microsoft.com/en-us/virtualization/windowscontainers/deploy-containers/containerd)

그리고 Windows에서는 컨테이너가 아래 그림과 같은 아키텍처 위에서 실행됩니다.
![container arch windows](https://images.gogumang.com/2f79b008d9/04.png) Windows 컨테이너 아키텍처 - [출처](https://docs.microsoft.com/en-us/virtualization/windowscontainers/deploy-containers/containerd)
...
![network compartment visual](https://images.gogumang.com/2f79b008d9/05.png) Host Network Service 아키텍처 - [출처](https://docs.microsoft.com/ko-kr/virtualization/windowscontainers/container-networking/network-isolation-security)
...
개발 환경에서 Windows 컨테이너를 빌드하고, 테스트하여, Docker Hub에 게시하는 과정을 살펴보도록 하겠습니다.

[다음 글 보기: Windows 컨테이너 개발 환경 구축하고 테스트하기](https://tech.devsisters.com/posts/start-windows-container-dev)

## 참고 자료

* [Windows 컨테이너 정보](https://docs.microsoft.com/ko-kr/virtualization/windowscontainers/about/)
* [Windows Server Volume License 정보 (영어)](https://www.microsoft.com/en-us/licensing/product-licensing/windows-server)
* [OneCore Umbrella Library 레퍼런스 (영어)](https://docs.microsoft.com/en-us/windows/desktop/apiindex/umbrella-lib-onecore)
* [Windows 컨테이너 요구 사항 (영어)](https://docs.microsoft.com/en-us/virtualization/windowscontainers/deploy-containers/system-requirements)
* [Host Compute Service 소개 (영어)](https://techcommunity.microsoft.com/t5/Containers/Introducing-the-Host-Compute-Service-HCS/ba-p/382332)
* [Windows 컨테이너 네트워킹 (영어)](https://docs.microsoft.com/en-us/virtualization/windowscontainers/container-networking/architecture)
* [네트워크 격리와 보안 (영어)](https://docs.microsoft.com/en-us/virtualization/windowscontainers/container-networking/network-isolation-security)

![deco cookie](https://images.gogumang.com/2f79b008d9/06.png)
