...
![background](https://images.gogumang.com/e2eaa40ebd/01.jpg)
...
또한, LIKE 질의를 사용하는 기존 DB 검색과 ES 검색의 결과를 비교한 POC 결과는 다음과 같습니다. ![es-start](https://images.gogumang.com/e2eaa40ebd/02.png)
...
검색 엔진을 적용한 후에 아래와 같은 피드백이 들어왔습니다. ![es-bacon-result](https://images.gogumang.com/e2eaa40ebd/03.png)
...
`통베` 라고 검색했을때 `통베이컨(에스푸드)` 품목이 올라오기 위한 가중치 조절과 N-gram Filter 조정이 필요해보였습니다. ![sapjil](https://images.gogumang.com/e2eaa40ebd/04.jpeg) 최적의 가중치와 N-gram Filter 설정을 찾기 위해 통베이컨 품목을 기준으로
~~삽질을~~
테스트를 아래와 같이 해보았는데요.

![es-ngram](https://images.gogumang.com/e2eaa40ebd/05.png) ![es-ngram](https://images.gogumang.com/e2eaa40ebd/06.png)
...
위 작업을 배포하고 내부에서 아래와 같은 피드백을 받았습니다. ![es2](https://images.gogumang.com/e2eaa40ebd/07.png)
...
![huguma](https://images.gogumang.com/e2eaa40ebd/08.jpeg)
...
![jaso-icu-analyzer](https://images.gogumang.com/e2eaa40ebd/09.png)
...
![icu-analzyer](https://images.gogumang.com/e2eaa40ebd/10.png)
...
![es-sweetcorn](https://images.gogumang.com/e2eaa40ebd/11.png)
...
그렇다는 것은 로컬 테스트코드와 실제 환경의 검색 결과가 다르다는 것이고, 지금까지의 테스트가 유효한게 맞을까.. 하는 생각이 들었는데요. ![es5](https://images.gogumang.com/e2eaa40ebd/12.jpeg)
...
![idf](https://images.gogumang.com/e2eaa40ebd/13.png) ![idf](https://images.gogumang.com/e2eaa40ebd/14.png) 결과만 보았을 때 확실히 IDF 를 포함했을 때보다 IDF 를 제외했을 때 결과가 개선되긴 했지만, 여전히 단순 TF 계산식, BM 모델 계산식의 결과는 크게 차이가 없었습니다.
...
![final](https://images.gogumang.com/e2eaa40ebd/15.png)
...
![final](https://images.gogumang.com/e2eaa40ebd/16.png) ![final](https://images.gogumang.com/e2eaa40ebd/17.png)
...
![final](https://images.gogumang.com/e2eaa40ebd/18.png)
...
![page-query](https://images.gogumang.com/e2eaa40ebd/19.png)
...
![chillguy](https://images.gogumang.com/e2eaa40ebd/20.png)