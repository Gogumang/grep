...
![bayes01.png](https://images.gogumang.com/784db66f9f/01.png)
...
![bayes02.png](https://images.gogumang.com/784db66f9f/02.png)
...
![bayes03_1.png](https://images.gogumang.com/784db66f9f/03.png)

Contour Map을 살펴보면 Data를 넣을수록 점점 `\theta_1`과 `\theta_2`의 값에 대한 확률이 높아지면서 확신이 생기고 있습니다. `\theta_1`과 `\theta_2`는 음의 상관관계가 있는 것도 보입니다.

![bayes03_2.png](https://images.gogumang.com/784db66f9f/04.png)

`\theta_1`은 `0`일 확률이 높고, `\theta_2`는 `-0.7`일 확률이 높은 것을 알 수 있습니다.

![bayes03_3.png](https://images.gogumang.com/784db66f9f/05.png)
...
![bayes04_1.png](https://images.gogumang.com/784db66f9f/06.png)

![bayes04_2.png](https://images.gogumang.com/784db66f9f/07.png)

![bayes04_3.png](https://images.gogumang.com/784db66f9f/08.png)
...
![bayes05_1.png](https://images.gogumang.com/784db66f9f/09.png)

![bayes05_2.png](https://images.gogumang.com/784db66f9f/10.png)
