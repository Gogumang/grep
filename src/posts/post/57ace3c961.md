[![NHN Cloud_meetup banner_cve_202607_900.png](https://images.gogumang.com/57ace3c961/01.png)](https://www.nhncloud.com/kr)
...
![NHN Cloud_meetup_data-forgery_1.png](https://images.gogumang.com/57ace3c961/02.png)
...
![NHN Cloud_meetup_luaCallFunction_1.png](https://images.gogumang.com/57ace3c961/03.png)
...
![NHN Cloud_meetup_luaRedisErrorReplyCommand_1.png](https://images.gogumang.com/57ace3c961/04.png)
...
![NHN Cloud_meetup_ex_error_1.png](https://images.gogumang.com/57ace3c961/05.png)
...
![NHN Cloud_meetup_error_1.png](https://images.gogumang.com/57ace3c961/06.png)
...
![NHN Cloud_meetup_luaPushErrorBuff_1.png](https://images.gogumang.com/57ace3c961/07.png)
...
해당 코드 내에서 `addReplyErrorLength` 함수를 호출하면서 오류 메시지를 버퍼에 추가합니다. ![NHN Cloud_meetup_addReplyErrorSdsEx_1.png](https://images.gogumang.com/57ace3c961/08.png)

이 함수는 `sdsmapchars()` 같은 sanitization 없이 오류 메시지를 그대로 전달합니다.

**2. addReplyErrorLength() - networking.c:565** ![NHN Cloud_meetup_addReplyErrorLength_1.png](https://images.gogumang.com/57ace3c961/09.png)

오류 메시지가 이미 `-`로 시작하면 그대로 전송합니다. `addReplyProto()` 함수를 호출하며 `s` 값을 버퍼에 넣기 위한 함수를 호출합니다.

**3. _addReplyToBuffer() - networking.c:403** ![NHN Cloud_meetup_addReplyToBuffer_1.png](https://images.gogumang.com/57ace3c961/10.png)

최종적으로 `memcpy()`를 통해 클라이언트의 출력 버퍼(`c->buf`)에 데이터가 직접 기록됩니다.

따라서 공격자가 `error(redis.error_reply("X\r\n+FAKE"))`를 실행하면 버퍼 상태가 다음과 같이 채워집니다. ![NHN Cloud_meetup_client_buffer_1.png](https://images.gogumang.com/57ace3c961/11.png)
...
공격자가 거대한 길이를 주입하면 ![NHN Cloud_meetup_dos_1.png](https://images.gogumang.com/57ace3c961/12.png)

클라이언트 버퍼가 다음과 같이 채워집니다. ![NHN Cloud_meetup_client_buffer_2.png](https://images.gogumang.com/57ace3c961/13.png)
...
[![NHN Cloud_meetup banner_footer_202507-01.png](https://images.gogumang.com/57ace3c961/14.png)](https://www.nhncloud.com/kr)