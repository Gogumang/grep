...
[영상 보기](https://blog.banksalad.com/5563a71fa865aa932dbdd374138462a2/BPLExample.mov)
...
![기획자: 그래서, 여기서 딱 다이얼로그가 뜨면 좋겠다는 겁니다. 디자이너:아 그거 저희는 팝업이라고 하는데 그거 말씀이신가요? 개발자: 아 알럿 말씀하시는 거군요? 하지만 사실은 다들 서로 다른 것을 말하고 있었다고 한다](https://images.gogumang.com/fc4bd6f752/01.png)

또는 이런 대화는 어떤가요?

![디자이너: 여기 이 버튼옆에 이미지만 하나 추가해 주세요. 개발자: 아 그건 구현상 뭐가 어떻게 되어있어서 이걸 바꾸면 다른데도 영향이 가고 이러저러해서 복잡해요😭 디자이너:(뭐가 복잡하단건지 설명은 들었지만 이해가 안 간다 ㅠㅠ 우리 스케치 심볼처럼 만들어 놓으면 옆에 이미지 하나 추가하는 건 일도 아닐텐데… 😭😭)](https://images.gogumang.com/fc4bd6f752/02.png)
...
![디자이너와 개발자가 서로 다른 단위로 컴포넌트를 추상화 한 예시](https://images.gogumang.com/fc4bd6f752/03.png)
...
![디자이너가 설명한 것에 대해 iOS, Android, Web개발자가 각자 다시 설명해 보지만 디자이너는 모두 다 잘못 이해했다고 하는 장면](https://images.gogumang.com/fc4bd6f752/04.png)
...
![위 코드들고 구현한 화면](https://images.gogumang.com/fc4bd6f752/05.png)
...
![Zeplin이 디자이너의 고민 내용을 개발자에게 가려주는 모습](https://images.gogumang.com/fc4bd6f752/06.png)
...
![개발자가 Zeplin의 벽을 넘어와 디자이너와 고민의 내용을 공유하는 모습](https://images.gogumang.com/fc4bd6f752/07.png)
...
![Figma에서 Viewer모드로 컴포넌트의 속성을 살펴보는 모습](https://images.gogumang.com/fc4bd6f752/08.png)
...
![Figma에서 Editor모드로 컴포넌트의 속성을 살펴보는 모습](https://images.gogumang.com/fc4bd6f752/09.png)
...
![매우 유사한 두 개의 Figma 컴포넌트](https://images.gogumang.com/fc4bd6f752/10.png)
...
![매우 유사한 두 개의 컴포넌트를 구현한 소스코드](https://images.gogumang.com/fc4bd6f752/11.png)
...
![컴포넌트 사이의 위계가 Figma에서 드러나는 모습](https://images.gogumang.com/fc4bd6f752/12.png)
...
![스냅샷 테스트가 실패한 모습](https://images.gogumang.com/fc4bd6f752/13.png)
...
![BPL_iOS 샘플앱의 모습](https://images.gogumang.com/fc4bd6f752/14.gif)
...
![BPL_IntegralExample 샘플앱의 모습](https://images.gogumang.com/fc4bd6f752/15.gif)
...
![개편된 뱅크샐러드와 이전 뱅크샐러드의 비교](https://images.gogumang.com/fc4bd6f752/16.png)
