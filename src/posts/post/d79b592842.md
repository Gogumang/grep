...
![성능 평가 결과 그래프](https://images.gogumang.com/d79b592842/01.png)
...
아래는 비교 결과 그래프입니다. 아래 그래프에서 확인할 수 있듯이 정상 클래스 F1과 NG 클래스 F1 모두 후보 토큰을 생성할 확률 기반으로 분류했을 때 개선되는 것을 확인할 수 있었습니다.

![비교 결과 그래프](https://images.gogumang.com/d79b592842/02.png)

다음으로 임곗값 설정 여부에 따른 정밀도(아래 왼쪽 그래프)와 재현율(아래 오른쪽 그래프) 성능 차이를 살펴보겠습니다.

![정밀도 및 재현율 비교 그래프](https://images.gogumang.com/d79b592842/03.png)
