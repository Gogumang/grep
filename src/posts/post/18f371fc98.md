...
> `libdcgm.so`은 DCGM 기반 모니터링에서 사용되는 GPU의 상태, 이벤트 등을 수집하는 라이브러리입니다.
> 따라서 GPU 연산 자체에 영향을 주진 않지만 DCGM을 사용한 GPU 상태 모니터링은 불가능하다고 볼 수 있습니다..

![Bottlerocket AMI GPU 노드의 Kubernetes 이벤트 로그](/static/deac11fbd751bde75fe88f3c7dfb13c6/37523/k8s-event-log-dcgm-issue.png "Bottlerocket AMI GPU 노드의 Kubernetes 이벤트 로그")
