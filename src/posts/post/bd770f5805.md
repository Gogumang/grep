![](https://images.gogumang.com/bd770f5805/01.png) *1부에서 "왓챠 웹이 PiP를 지원한다"고 알려드렸습니다. 이번 편은* ***실제 적용기*** *입니다. 특히 DRM 영상·자막·왓챠파티가 얽힌 실서비스에 붙이는 건 전혀 다른 일이었습니다.*
...
![](https://images.gogumang.com/bd770f5805/03.gif) PiP로 전환할 때마다 뜨는 오프닝 건너뛰기 팝업 (DRM 때문에 검정 화면으로 보여요)
...
![](https://images.gogumang.com/bd770f5805/04.gif) 별도 팝업없이 재생이 정상적으로 이어짐 (DRM 때문에 검정 화면으로 보여요)
...
![](https://images.gogumang.com/bd770f5805/05.gif) 에피소드를 변경하면 무한 로딩이 발생함
...
![](https://images.gogumang.com/bd770f5805/06.png) [사진 출처](https://developer.chrome.com/docs/web-platform/document-picture-in-picture?hl=ko)

이 둘을 우리 UI에 그리고 싶었는데, 막상 보니 **각 버튼에 대한 통제권이 달랐습니다.**
![](https://images.gogumang.com/bd770f5805/07.png)
...
![](https://images.gogumang.com/bd770f5805/08.png) 실제 적용된 모습
