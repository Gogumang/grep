...
![](https://images.gogumang.com/59eac9b2df/01.avif) 체크리스트

이후, 대외기관과 신용정보원에서 받아온 정보 등을 토대로 산출된 가심사 결과를 확인하고
![](https://images.gogumang.com/59eac9b2df/02.avif) 가심사

산출된 상품 중 신청하고자 하는 상품을 선택하고, 서류 제출 과정을 거치게 돼요.
사용자의 인증이 필요한 경우는 인증을 완료한 후 진행됩니다.
![](https://images.gogumang.com/59eac9b2df/03.avif) 서류 제출
...
![](https://images.gogumang.com/59eac9b2df/04.avif) 실행
...
![](https://images.gogumang.com/59eac9b2df/05.avif)
...
![](https://images.gogumang.com/59eac9b2df/06.avif)
...
다이내믹 스크래핑을 활용했습니다.
다이내믹 스크래핑이란, PO/PM/QA/DA/디자이너/FE/BE 등 **누구나 사업자, 프리랜서, 기혼, 미혼, 청년**이 될 수 있도록 만든 기능이에요.
...
![](https://images.gogumang.com/59eac9b2df/07.avif) 다이내믹 스크래핑
...
![](https://images.gogumang.com/59eac9b2df/08.avif) 배우자 동의 요청

두번째, 근로소득자가 아닌데 근로소득을 선택했거나, 사업소득자가 아닌데 사업소득을 선택한 경우 서류 수집 과정에서 부결 처리되는 과정이에요.
![](https://images.gogumang.com/59eac9b2df/09.avif) 서류 수집 과정에서의 부결
...
![](https://images.gogumang.com/59eac9b2df/10.avif) 전략 패턴 ![](https://images.gogumang.com/59eac9b2df/11.avif) 전략 패턴 적용
...
![](https://images.gogumang.com/59eac9b2df/12.avif) LUMOS

LUMOS에서 처리하는 몇가지 화면을 같이 볼까요?
![](https://images.gogumang.com/59eac9b2df/13.avif) 서류 확인
...
![](https://static.toss.im/ipd-tcs/toss_core/live/97116a16-132b-4882-afe0-0063ecff76c2/image_(1).png) 소득 확인

두번째는 고객이 제출한 서류로 산출된 소득을 확인하는 화면이에요. 소득 산출 또한 모두 자동화했어요.
![](https://static.toss.im/ipd-tcs/toss_core/live/41a81542-0b10-404d-b698-fb3cbd5db62a/image_(2).png) 알림 및 LMS 확인

세번째, 알림 또는 LMS 발송 여부와 발송된 내용을 확인할 수 있는 화면이에요. 재발송도 가능하고, 필요하면 직접 작성한 내용을 고객에게 발송할 수도 있어요.
![](https://images.gogumang.com/59eac9b2df/14.avif) 이미지 조회
...
![](https://images.gogumang.com/59eac9b2df/15.avif) 긍정적인 의견
...
![](https://images.gogumang.com/59eac9b2df/16.avif) 자금 이체 종류
...
![](https://images.gogumang.com/59eac9b2df/17.avif)
...
![](https://images.gogumang.com/59eac9b2df/18.avif)
...
![](https://images.gogumang.com/59eac9b2df/19.avif) 대환 프로세스에 필요한 상태들

상태를 정의해보자면 위와 같은 여러 상태들이 있을 것 같아요.
![](https://images.gogumang.com/59eac9b2df/20.avif) 진행 상태 나열 1 ![](https://images.gogumang.com/59eac9b2df/21.avif) 진행 상태 나열 2

이 상태들을 나름의 순서를 만들어 나열해보면 위와 같이 나열할 수 있는데요.
![](https://images.gogumang.com/59eac9b2df/22.avif) 전략 \& 상태 \& 사가 패턴

결론적으로 복잡한 if-else를 제거하고, 상태들이 순서대로 잘 진행되도록 구현하기 위해 전략 패턴과 상태 패턴 그리고 사가 패턴을 적용했습니다.
![](https://images.gogumang.com/59eac9b2df/23.avif) 자금 이체 프로세스를 처리하는 Orchestrator
...
![](https://images.gogumang.com/59eac9b2df/24.avif) 자금 이체가 필요하지 않은 프로세스를 처리하는 Orchestrator

대환 프로세스에는 자금 이체가 필요하지 않은 단계도 있는데요.
자금 이체가 필요하지 않은 경우는 Orchestrator가 다른 마이크로 서버와의 통신 등과 같은 처리로 다음 단계로 진행해요.
![](https://images.gogumang.com/59eac9b2df/25.avif) 주기적 상환 결과 조회
...
저희는 지금도 **이전으로 돌아갈 수 없는 새로운 은행 경험을 제공**하기 위해 노력하고 있습니다.
