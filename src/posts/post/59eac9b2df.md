...
![](/images/59eac9b2df/07.png) 다이내믹 스크래핑
...
![](/images/59eac9b2df/10.png) 전략 패턴 ![](/images/59eac9b2df/11.png) 전략 패턴 적용
...
![](/images/59eac9b2df/12.png) LUMOS

LUMOS에서 처리하는 몇가지 화면을 같이 볼까요?
![](/images/59eac9b2df/13.png) 서류 확인
...
![](/images/59eac9b2df/14.png) 이미지 조회
...
![](/images/59eac9b2df/15.png) 긍정적인 의견
...
![](/images/59eac9b2df/16.png) 자금 이체 종류
...
![](/images/59eac9b2df/19.png) 대환 프로세스에 필요한 상태들

상태를 정의해보자면 위와 같은 여러 상태들이 있을 것 같아요.
![](/images/59eac9b2df/20.png) 진행 상태 나열 1 ![](/images/59eac9b2df/21.png) 진행 상태 나열 2

이 상태들을 나름의 순서를 만들어 나열해보면 위와 같이 나열할 수 있는데요.
![](/images/59eac9b2df/22.png) 전략 \& 상태 \& 사가 패턴

결론적으로 복잡한 if-else를 제거하고, 상태들이 순서대로 잘 진행되도록 구현하기 위해 전략 패턴과 상태 패턴 그리고 사가 패턴을 적용했습니다.
![](/images/59eac9b2df/23.png) 자금 이체 프로세스를 처리하는 Orchestrator
