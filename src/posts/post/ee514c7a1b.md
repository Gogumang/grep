...
![code-review](https://spoqa.github.io/images/coding-convention-story/code-review.png)
...
![sonarqube-issues](https://spoqa.github.io/images/coding-convention-story/sonarqube-issues.png)
...
이 글의 목적은 Konsist를 자세히 소개하는 데 있지 않습니다. Konsist를 시작하는 방법이나 설치 가이드는 [공식 홈페이지](https://docs.konsist.lemonappdev.com/) 에서 확인하실 수 있습니다. 대신, 이 글에서는 우리 팀이 Konsist를 활용하고 있는 몇 가지 사례를 통해, 이 도구를 어떻게 효과적으로 사용할 수 있을지 감을 잡을 수 있도록 도와드리고자 합니다.

#### 구조 컨벤션

우리 팀은 명확하고 이해하기 쉬우며 유지보수성을 높일 수 있도록 아래처럼 단순한 프로젝트 구조를 사용하고 있습니다.

![architecture](https://spoqa.github.io/images/coding-convention-story/architecture.png)

Domain 레이어는 데이터 및 비즈니스 로직과 같은 도메인 로직을 처리하는 코드들이 위치하며, Application 레이어는 표현 계층, Facade, 그리고 외부 리소스와의 연동을 담당하는 기반 코드들이 포함되어 있습니다.
...
![architectural-test-result](https://spoqa.github.io/images/coding-convention-story/architectural-test-result.png)
...
![property-test-result](https://spoqa.github.io/images/coding-convention-story/property-test-result.png)
