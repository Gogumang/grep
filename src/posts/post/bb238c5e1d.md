...
![](/images/bb238c5e1d/01.png) 표1. CloudFront와 Lambda@Edge를 활용한 간단한 카나리 배포 아키텍처
...
![](https://static.toss.im/ipd-tcs/toss_core/live/14d98c3e-6d2d-4519-9fbd-acc3ed014c18/스크린샷_2024-03-04_오전_5.54.57.png) 그림 3. 위와 같이 Origin Request 정책에 Cloudfront-viewer-ja3-fingerprint' 를 추가하면 CloudFront 함수에서 접근이 가능해진다.
...
![](/images/bb238c5e1d/03.png) 그림 4. X-Toss-Cohort 값에 따라 응답 결과가 달라지도록 캐시 키 설정
