...
![](/images/bb238c5e1d/01.avif) 표1. CloudFront와 Lambda@Edge를 활용한 간단한 카나리 배포 아키텍처
...
![](/images/bb238c5e1d/02.avif) 그림 3. 위와 같이 Origin Request 정책에 Cloudfront-viewer-ja3-fingerprint' 를 추가하면 CloudFront 함수에서 접근이 가능해진다.
...
![](/images/bb238c5e1d/03.avif) 그림 4. X-Toss-Cohort 값에 따라 응답 결과가 달라지도록 캐시 키 설정
