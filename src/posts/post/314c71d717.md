[![NHN Cloud_meetup banner_certificate_202603_900.png](https://images.gogumang.com/314c71d717/01.png)](https://www.nhncloud.com/kr)

## 들어가며

인증서의 유효기간이 당장 2026년 3월 15일부터 **1년에서 200일로 단축** 되며, 단계적으로 줄어들어 **2029년 3월에는 47일** 이 됩니다. 수동으로 갱신한다면 매일 인증서 교체만 하게 될 것 같은데요. 😭 하지만 **ACME (Automated Certificate Management Environment)** 프로토콜을 활용하면 발급부터 갱신까지 자동화할 수 있습니다! 👏 이 글에서는 인증서 유효기간 단축의 배경과 ACME 기반 자동화 구축 방법에 대해 다뤄보겠습니다.
> 인증서의 개념과 중요성에 대해 알아보았던 지난 글은 아래 경로에서 다시 읽어 보실 수 있습니다. [🔎인증서 톺아보기 시리즈 1: 인증서란? 디지털 신뢰의 시작](https://meetup.nhncloud.com/posts/409)
...
![certificate2_1.png](https://images.gogumang.com/314c71d717/02.png)

### 왜 짧아지는가?

#### 1. 보안 향상

![NHN Cloud_meetup_certificate2_2_900.png](https://images.gogumang.com/314c71d717/03.png)
...
짧은 유효기간은 폐기 시스템에 대한 의존도를 줄입니다. 인증서 자체가 빨리 만료되므로, 폐기 메커니즘이 제대로 작동하지 않아도 보안 위험이 자연스럽게 줄어듭니다.
...
![NHN Cloud_meetup_certificate2_3_900.png](https://images.gogumang.com/314c71d717/04.png)
...
![NHN Cloud_meetup_certificate2_4_900.png](https://images.gogumang.com/314c71d717/05.png)
...
**폐기 시스템의 중요도 감소** 점점 짧아지는 유효기간이 폐기 메커니즘을 대체하면서, Let's Encrypt는 OCSP URL을 완전히 제거하고 CRL Distribution Point만 제공하도록 전환했습니다. 인증서 자체가 빠르게 만료되므로, 폐기 시스템에 대한 의존도가 자연스럽게 줄어드는 추세입니다.
...
✅ 유효기간 단축은 보안 향상을 위한 불가피한 흐름 ✅ 자동화는 선택이 아닌 필수 ✅ ACME 프로토콜은 검증된 표준 솔루션 ✅ 지금 시작하면 미래 변화에 대비 가능

**인증서를 수동으로 갱신하던 시**는 이제 역사가 되어가고 있습니다.

ACME 프로토콜과 자동화 도구의 개념을 확실히 이해하고, 지금부터 준비한다면 앞으로의 변화에 능동적으로 대응할 수 있습니다. 마지막으로 다음 글에서는 우리가 곧 마주하게 될(이미 마주한) **Zero Trust와 mTLS에 대한 내용**을 다뤄보도록 하겠습니다.
...
[![NHN Cloud_meetup banner_footer_mint_202601.png](https://images.gogumang.com/314c71d717/06.png)](https://www.nhncloud.com/kr)