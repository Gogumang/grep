...
Hyperconnect는 전사 NoSQL 데이터베이스로 ScyllaDB를 약 4년 동안 운영하며, ML feature store[\[2\]](https://deview.kr/2023/sessions/536) 등 전사의 매우 다양한 서비스의 고성능 요구사항을 충족해왔습니다. 하지만 최근 장애 모의 훈련에서 cluster rolling update 시 node 복구 시간이 지나치게 길다는 문제를 발견했습니다. 본 글에서는 이 문제를 해결하기 위해 도입한 **Super Disk (Write-mostly RAID)** 기능이 어떻게 cluster rolling update 시간을 기존 대비 **최대 10배 이상 단축** 시켰으며 , 성능상에는 어떤 차이가 있는지, 이러한 결론을 바탕으로 해당 기능을 Kubernetes 환경에서 더욱 효율적으로 관리하기 위해 도입한 **Windmill 기반 자동화 과정**까지 단계별로 소개합니다.
...
1. **Cassandra의 Cache 접근 방식**
   ...
   ![cassandra-cache.png](https://hyperconnect.github.io/assets/2025-05-15-Building-Resilient-High-Performance-ScyllaDB-Clusters-with-Super-Disk/cassandra-cache.png)
...
![](https://hyperconnect.github.io/assets/2025-05-15-Building-Resilient-High-Performance-ScyllaDB-Clusters-with-Super-Disk/i4i-no-raid-performance-benchmark.png)

*RAID를 적용하지 않은 i4i instance의 성능 벤치마크 결과*
![](https://hyperconnect.github.io/assets/2025-05-15-Building-Resilient-High-Performance-ScyllaDB-Clusters-with-Super-Disk/i4i-raid-performance-benchmark.png)
...
i4i.4xlarge wih EBS raid - benchmark results
...
* 초기 Migration workflow
  * 우선 Super Disk를 적용하기 위해서, Super Disk가 적용된 ScyllaDB node 로 데이터를 migration 진행해야 합니다. 이때 새로운 ScyllaDB instance 들을 provisioning 하고, 이를 미리 provisioning 한 EBS 와 RAID 를 수행해야 하는데, 이를 자동화하여 새로운 ScyllaDB instance 에 RAID 를 수행하는 workflow 를 만들었습니다.
    ...
    ![windmill-init.png](https://hyperconnect.github.io/assets/2025-05-15-Building-Resilient-High-Performance-ScyllaDB-Clusters-with-Super-Disk/windmill-init.png)
* EBS RAID 기반 ScyllaDB instance 교체 workflow
  ...
  * 새 방식에 맞춰 node를 drain하고, RAID를 해제하고, EBS를 다른 instance에 attach하는 과정을 자동화해야 합니다. 따라서 이를 자동화 하는 workflow 를 생성하였습니다.
    ...
    ![windmill-scylla-node-replace.png](https://hyperconnect.github.io/assets/2025-05-15-Building-Resilient-High-Performance-ScyllaDB-Clusters-with-Super-Disk/windmill-scylla-node-replace.png)
...
![](https://hyperconnect.github.io/assets/2025-05-15-Building-Resilient-High-Performance-ScyllaDB-Clusters-with-Super-Disk/scylla-prod-raid.png)

*RAID를 적용한 i4i instance의 Production 성능 결과*
![](https://hyperconnect.github.io/assets/2025-05-15-Building-Resilient-High-Performance-ScyllaDB-Clusters-with-Super-Disk/scylla-prod-non-raid.png)
...
![write-mostly.png](https://hyperconnect.github.io/assets/2025-05-15-Building-Resilient-High-Performance-ScyllaDB-Clusters-with-Super-Disk/write-mostly.png)
...
\[1\] [ML Feature Store @ Hyperconnect (DEVIEW 2023)](https://deview.kr/2023/sessions/536)

\[2\] [ScyllaDB vs. Cassandra](https://www.scylladb.com/scylladb-vs-cassandra/#)

\[3\] [Cassandra 4.0 vs. Scylla Open Source 4.4 Benchmark](https://lp.scylladb.com/cassandra-4.0-vs-scylla-benchmark-offer)

\[4\] [SRE 팀은 장애에 어떻게 대응할까? Hyperconnect 장애 모의 훈련](https://hyperconnect.github.io/2024/11/12/sre-incident-training.html)

\[5\] [ScyllaDB Disk Requirements](https://opensource.docs.scylladb.com/stable/getting-started/system-requirements.html#disk-requirements)

\[6\] [7 Reasons Not to Put an External Cache in Front of Your Database](https://www.scylladb.com/2017/07/31/database-caches-not-good/)

\[7\] [How Discord Supercharges Network Disks for Extreme Low Latency](https://discord.com/blog/how-discord-supercharges-network-disks-for-extreme-low-latency)

\[8\] [YCSB - Yahoo! Cloud Serving Benchmark](https://github.com/brianfrankcooper/YCSB)

\[9\] [Latte - ScyllaDB Benchmark Tool](https://github.com/scylladb/latte?tab=readme-ov-file)

\[10\] [ScyllaDB Monster Scale Summit](https://www.scylladb.com/monster-scale-summit/on-demand/)

\[11\] [ScyllaDB is No Longer "Just a Faster Cassandra" (ScyllaDB Monster Scale Summit Tech Talk)](https://www.scylladb.com/tech-talk/scylladb-is-no-longer-just-a-faster-cassandra/)

\[12\] [Benchmark Workload example for ScyllaDB Latte](https://github.com/fee-mendes/scylladb-c5/blob/main/profiles/workload.rn)

\[13\] [Log-Structured Merge-Tree (LSM Tree)](https://www.scylladb.com/glossary/log-structured-merge-tree/)

\[14\] [Hinted Handoff (ScyllaDB Documentation)](https://opensource.docs.scylladb.com/stable/architecture/anti-entropy/hinted-handoff.html)