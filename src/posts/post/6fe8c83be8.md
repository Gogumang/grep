...
2. **처리 외 시간**: 처리 시간 밖의 모든 시간. Flink에서 데이터를 de/serialize하거나 네트워크 I/O를 하는 시간 등이 포함됩니다.
...
![example_job_graph.png](https://hyperconnect.github.io/assets/2025-03-28-flink-e2e-latency/example_job_graph.png)
...
![example_latency_pie_chart.png](https://hyperconnect.github.io/assets/2025-03-28-flink-e2e-latency/example_latency_pie_chart.png)

그림 2. 위 예시에서 수집한 지표를 모아 파이 차트로 나타낸 것

처리 시간은 **Operator 1** , 처리 외 시간은 **Operator 1 Non-Process**의 형태로 수집하고 있다.
...
![example_flame_graph.png](https://hyperconnect.github.io/assets/2025-03-28-flink-e2e-latency/example_flame_graph.png)
...
![flame_graph_1.png](https://hyperconnect.github.io/assets/2025-03-28-flink-e2e-latency/flame_graph_1.png)
...
![flame_graph_2.png](https://hyperconnect.github.io/assets/2025-03-28-flink-e2e-latency/flame_graph_2.png)
...
![flame_graph_3.png](https://hyperconnect.github.io/assets/2025-03-28-flink-e2e-latency/flame_graph_3.png)
