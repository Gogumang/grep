...
![text](https://images.gogumang.com/5a138ff90d/01.gif) 사람이 빠르게 움직이는 이미지를 동작으로 인식하는 매커니즘 Youtube@Andymation
...
![Unsplash@jannerboy62](https://images.gogumang.com/5a138ff90d/02.png) Unsplash@jannerboy62
...
![Understand Kotlin Coroutines on Android (Google I/O'19)](https://images.gogumang.com/5a138ff90d/03.png) Understand Kotlin Coroutines on Android (Google I/O'19)
...
![Understand Kotlin Coroutines on Android (Google I/O'19)](https://images.gogumang.com/5a138ff90d/04.png) Understand Kotlin Coroutines on Android (Google I/O'19)
...
![중단 가능 지점을 표현하는 화살표](https://images.gogumang.com/5a138ff90d/05.png) 중단 가능 지점을 표현하는 화살표
...
![아니요](https://images.gogumang.com/5a138ff90d/06.png) 아니요
...
![스레드에서 실행되지만, 스레드에 종속적이지 않은 Coroutine을 보여주는 자료](https://images.gogumang.com/5a138ff90d/07.png) 스레드에서 실행되지만, 스레드에 종속적이지 않은 Coroutine을 보여주는 자료
...
![createCoroutines(100)을 호출했을때](https://images.gogumang.com/5a138ff90d/08.png) createCoroutines(100)을 호출했을때

<br />

<br />

![createThreads(100)을 호출했을때](https://images.gogumang.com/5a138ff90d/09.png) createThreads(100)을 호출했을때
...
![createCoroutines(1000)을 호출했을때](https://images.gogumang.com/5a138ff90d/10.png) createCoroutines(1000)을 호출했을때

<br />

<br />

![createThreads(1000)을 호출했을때](https://images.gogumang.com/5a138ff90d/11.png) createThreads(1000)을 호출했을때
...
![createCoroutines(10000)을 호출했을때](https://images.gogumang.com/5a138ff90d/12.png) createCoroutines(10000)을 호출했을때

<br />

<br />

![createThreads(10000)을 호출했을때](https://images.gogumang.com/5a138ff90d/13.png) createThreads(10000)을 호출했을때
...
![amount 값에 따른 createThreads와 createCoroutines의 실행 결과](https://images.gogumang.com/5a138ff90d/14.png) amount 값에 따른 createThreads와 createCoroutines의 실행 결과
