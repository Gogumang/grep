다음은 미용의료 병원의 AI OS인 KOS를 만들고 있는 병원솔루션 사업부의 이야기입니다. KOS 제품에 대한 소개는
[여기를 눌러](https://kos-solution.com/)
...
이 글을 읽기 전에 숙지하고 계셔야 이해하기 편한 내용들이 있습니다.

* [기본적인 kubernetes에 대한 개념 및 사용법](https://kubernetes.io/docs/home/) 제품이 kubernetes cluster에서 구동되게 작업되어 있습니다.
* [GitHub Actions](https://docs.github.com/en/actions) CI/CD 파이프라인을 실행시키는 러너로 GitHub Actions를 이용하였습니다.
* [self-hosted runner GitHub Actions](https://docs.github.com/en/actions/hosting-your-own-runners/about-self-hosted-runners) private VPC에 있는 EKS에 접근하기 위해서 self-hosted runner를 이용하였습니다.
...
![219d9338-d3d4-8084-92e0-e50df03c710b.png](https://images.gogumang.com/1db3abcbd7/01.webp)
