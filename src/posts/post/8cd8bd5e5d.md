...
![버그 지금 잡으러 갑니다](https://images.gogumang.com/8cd8bd5e5d/01.webp)
...
![하이버네이트 localTime 필드 db 저장 로직](https://images.gogumang.com/8cd8bd5e5d/02.webp)
...
![하이버네이트 unwrap 메서드 코드](https://images.gogumang.com/8cd8bd5e5d/03.webp)

![하이버네이트 getBinder 메서드 코드](https://images.gogumang.com/8cd8bd5e5d/04.webp)
> HikariProxyPreparedStatement.setTime ➡️ PreparedStatementSpy.setTime(index, time)

![HikariProxyPreparedStatement setTime 메서드 코드](https://images.gogumang.com/8cd8bd5e5d/05.webp)

![PreparedStatementSpy setTime 메서드 코드](https://images.gogumang.com/8cd8bd5e5d/06.webp)
...
![실제로 저장한 localTime 타입 값](https://images.gogumang.com/8cd8bd5e5d/07.webp)
...
![PreparedStatementSpy setTime 메서드 코드](https://images.gogumang.com/8cd8bd5e5d/08.webp)
...
![TimeJdbcType getExtractor 메서드 코드](https://images.gogumang.com/8cd8bd5e5d/09.webp)

![LocalTimeJavaType wrap 메서드 코드](https://images.gogumang.com/8cd8bd5e5d/10.webp)
